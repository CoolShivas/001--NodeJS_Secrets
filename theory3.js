 ...
 * -----History and Evolution
    ...
    • Creation of Node.js (2009): Ryan Dahl created 
    Node.js by taking the V8 JavaScript engine (used in Google Chrome) and running it outside the browser. This innovation allowed JavaScript to handle server side development.
    ...
    (npm) in 2010, revolutionizing JavaScript development by simplifying package sharing and dependency management.

     • io.js and Node.js Merger (2015): In 2015, Node.js merged with io.js, reuniting the ecosystem and 
    bringing in community-driven improvements
 
    • Node.js Foundation (2015):  The Node.js 
    Foundation was established to support
    collaboration, innovation, and sustainable development within the ecosystem.


     There has been lots of drama behind Node.js and its evolution. If you want to learn more, watch this video
